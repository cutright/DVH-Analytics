...
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_coord_string text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_cross_section_max text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_cross_section_median text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_spread_x text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_spread_y text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_spread_z text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_surface_area text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_volume text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_max_dose text;
ALTER TABLE Plans ADD COLUMN IF NOT EXISTS ptv_min_dose text;
