    ...
    def __init__(self, plan_file=None, structure_file=None, dose_file=None, dose_sum_file=None, plan_over_rides=None,
        ...
        if self.dose_file:
            if self.dose_sum_file is None:
                self.dicompyler_data['dose'] = dicompylerParser(self.dose_file)
            else:
                self.dicompyler_data['dose'] = dicompylerParser(self.dose_sum_file)
            self.rt_data['dose'] = self.dicompyler_data['dose'].ds
