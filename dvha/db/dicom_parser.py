...
class DICOM_Parser:
    ...
    def __init__(self, plan=None, structure=None, dose=None, dose_sum=None,
        ...
        if dose:
            ...
            if dose_sum is None:
                ...
                self.dicompyler_data['dose'] = dose_sum
    ...
    def import_dose_sum(self, dose_sum):
        """
        Simple function to update dicomplyer_data['dose'] with a dose_sum object
        :param dose_sum: the return from tools.dicom_dose_sum.SumPlan
        """
        self.dicompyler_data['dose'] = dose_sum
