...
#         sum_scaling = self.ds.DoseGridScaling + other.ds.DoseGridScaling
#         self.set_pixel_array(dose_sum, sum_scaling)
#
#     def set_pixel_array(self, pixel_data, scaling):
#
#         self.ds.BitsAllocated = 32
#         self.ds.BitsStored = 32
#         self.ds.HighBit = 31
#         self.ds.PixelData = np.uint32(pixel_data / scaling).tostring()
#         self.ds.DoseGridScaling = scaling
#
#     def update_pixel_array(self):
#         scaling = 1 / np.max(self.dose_grid)
#         self.set_pixel_array(np.swapaxes(self.dose_grid, 0, 2), scaling)
#
#     @property
#     def grid_size(self):
