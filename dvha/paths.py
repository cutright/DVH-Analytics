...
SQL_CNF_PATH_LAST_PGSQL = join(PREF_DIR, '.sql_connection_last_pgsql.cnf')
SQL_CNF_PATH_LAST_SQLITE = join(PREF_DIR, '.sql_connection_last_sqlite.cnf')
SQL_CNF_PATH_PGSQL_HIST = join(PREF_DIR, '.sql_connection_ip_history')
