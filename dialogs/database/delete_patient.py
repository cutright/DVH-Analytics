...
class DeletePatientDialog(wx.Dialog):
    def __init__(self, *args, **kw):
        wx.Dialog.__init__(self, None, title="Delete Patient")
        ...
        self.button_ok = wx.Button(self, wx.ID_OK, "Delete")
    ...
    def __do_layout(self):
        ...
        label_new_value = wx.StaticText(self, wx.ID_ANY, "Type Delete to Authorize:")
